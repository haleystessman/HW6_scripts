...
sudo curl https://raw.githubusercontent.com/haleystessman/AzureVM/main/default | sudo tee -a /etc/nginx/sites-available/default
...
sudo git clone https://github.com/haleystessman/HW6_website.git
